...
const baseHue = 36;
const rangeHue = 0;
//const backgroundColor = 'ctx.createLinearGradient(0, 0, 0, 170)';
let container;
let canvas;
let ctx;
let center;
...
function initPipe(i) {
  ...
  speed = 2 * (baseSpeed) + rand(rangeSpeed);
  life = 0;
...
function drawPipe(x, y, life, ttl, width, hue) {
  ctx.a.save();
  //ctx.a.strokeStyle = `hsla(45,100%,50%,1)`;
  ctx.a.strokeStyle = `hsla(${hue},1%,1%,${fadeInOut(life, ttl) * 0.125})`;
  ctx.a.beginPath();
...
function render() {
    console.log("render:::");
  ctx.b.save();
    var my_gradient = ctx.b.createLinearGradient(15, 15, 15, 170);
    my_gradient.addColorStop(0, "#4652bf");
    my_gradient.addColorStop(0.33, "#4652bf");
    my_gradient.addColorStop(0.67, "#1079da");
    my_gradient.addColorStop(1, "#76a8f2");
    ctx.b.fillStyle = my_gradient;
    //ctx.b.fillRect(20, 20, 150, 100);
