...
<div class="row justify-content-center inverse">
    <div class="col-lg-8 text-center">
        <div class="main_title">
            <h1>A good network is a reliable network</h1>
        </div>
    </div>
</div>
                    ...
                    <div class="row recent_update_text align-items-center">
                        <div class="col-md-12">
                            <div class="common_style row">
                                <p class= "col-md-12 line">Our motto : </p>
                                <h3 class= "col-md-12">
                                    The good job is the one that lasts in time</h3>
                                <div class="col-md-5 offset-1 p-4">
                                    <h5>Quality : </h5><br>
                                    <p>
                                        Quality of services ensured by: <br>
                                        - multiple prizes and awards, <br>
                                        - standards attested by our European projects, <br>
                                        - the continued use of the most advanced technology, <br>
                                ...
                                <div class="col-md-5 offset-1 p-4">
                                    <h5>Security : </h5><br>
                                    <p>
                                        We make security our priority: <br>
                                        - risk prevention, <br>
                                        - confidentiality of exchanges, <br>
                                ...
                                <div class="col-md-10 offset-1 text-center pt-4">
                                    <h5>
                                        Sustainable development: </h5><br>
                                    <p>
                                        All our research and development principles take into account environmental and
                                ...
                                <div class="col-md-10 offset-1 text-center p-4">
                                    ...
                                    <p>
                                        ...
                                        Our talented engineers strive to provide you with their work
                    ...
                    <div class="row recent_update_text align-items-center">
                        <div class="col-md-12">
                            <div class="common_style">
                                <p class="line">Our talents</p>
                                <h3>
                                    Who are the I.T. guys on the first floor? </h3>
                                <p>
                                    In all modesty, doctors and geniuses; <br>
                                    Experts in design and development of complex systems. <br>
                                    Basically, we know what we do. <br>
                                    We are dedicated to developing sustainable solutions: <br>
                                    - We bring you the fruits of our advanced research in network security. <br>
                                    - We make your networks easy to use. <br>
                                    Powerful tools at affordable prices, what each of us hopes to find in everything. <br>
                                    Some informations about us: <br>
                                    Between us all, we master 23 computer languages. <br>
                                    For us, the key to success is a happy customer. <br>
                                    Most of us, we are night owls.
                                </p>
                            </div>
                        </div>
...
<div class="col-md-12 p-5 sol">
    <a class="col-md-4 offset-1 primary_btn line" href="solutions.php"><span>See our solutions</span></a>
</div>
